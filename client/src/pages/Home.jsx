...
const Home = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center text-center md:gap-4 gap-3 p-4 min-h-screen">
      ...
      <h1 className="md:text-4xl text-2xl font-semibold">Hello <span className="text-indigo-600">{user ? user.username : "Developer"}</span>!</h1>
      <h2 className="md:text-5xl text-4xl font-bold">Welcome to Auth Application</h2>

      <p className="mt-4 text-lg font-medium">
        {user ? "You are logged in successfully." : "Sign in to your existing account or register your account securely."}
      </p>
